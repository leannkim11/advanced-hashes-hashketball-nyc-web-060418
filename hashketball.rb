...
def num_points_scored(player_name)
  game_hash.collect do |team, member|
    game_hash[team][:players].collect do |name, stats|
     if player_name == name
       return stats[:points]
      end
    end
...
def shoe_size(player_name)
  game_hash.each do |team, member|
    game_hash[team][:players].each do |name, shoes|
     if player_name == name
       return shoes[:shoe]
      end
    end
...
def team_colors(name_of_team)
  game_hash.each do |team, member|
    game_hash[team].each do |name, member|
        if name_of_team == member
